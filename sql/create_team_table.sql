...
(
    ...
    `team_type`       tinyint  default 1                 not null comment '队伍类型：1-学习小组，2-项目团队，3-竞赛队伍，4-社团组织',
    `status`          tinyint  default 1                 not null comment '状态：0-解散，1-招募中，2-活动中，3-停止招募',
    `is_public`       tinyint  default 1                 not null comment '是否公开：0-私有，1-公开',
    `is_apply`        tinyint  default 1                 not null comment '加入是否需要审批',
